...
class baseAjaxAddress extends baseAjax
{
    ...
    {        
        ...
        if ($form->getValue('term')) {
            ...
            $response = json_decode(file_get_contents("https://suggestions.dadata.ru/suggestions/api/4_1/rs/suggest/address", false, stream_context_create( array('http' => array('method' => 'POST', 'header' => "Content-Type: application/json\r\nAccept: application/json\r\nAuthorization: Token ".Constants::DADATA_TOKEN . PHP_EOL, 'content' => $request) ) )), "true");
