 ...
 *****************************************************************************/
	...
	abstract class AutoUser extends NamedObject implements Created
	{
		...
		protected $telegramId = null;
		protected $telegramBotEnabled = false;
		...
		**/
		...
		public function getTelegramBotEnabled()
		{
			return $this->telegramBotEnabled;
		}
		
		public function isTelegramBotEnabled()
		{
			return $this->telegramBotEnabled;
		}
		 ...
		 * @return User
		**/
		public function setTelegramBotEnabled($telegramBotEnabled = false)
		{
			$this->telegramBotEnabled = ($telegramBotEnabled === true);
