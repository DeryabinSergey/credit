...
class ViewTextUtils extends StaticFactory
{
	...
	$string = strtr($string, 
	    array_combine(
		["а","б","в","г","д","е","ж","з","и","й","к","л","м","н","о","п","р","с","т","у","ф","ы","э","А","Б","В","Г","Д","Е","Ж","З","И","Й","К","Л","М","Н","О","П","Р","С","Т","У","Ф","Ы","Э"],
		["a","b","v","g","d","e","g","z","i","y","k","l","m","n","o","p","r","s","t","u","f","i","e","A","B","V","G","D","E","G","Z","I","Y","K","L","M","N","O","P","R","S","T","U","F","I","E"]
	    )
	);
