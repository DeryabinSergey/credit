...
class AclContextDropCommand extends DropCommand implements SecurityCommand
{
    const ERROR_EXTERNAL = 0x0003;

    /**
     * @return AclContextDropCommand
     */
    ...
    public function run(Prototyped $subject, Form $form, HttpRequest $request)
    {
        ...
        if ($mav->getView() != EditorController::COMMAND_SUCCEEDED) {
            ...
            try {
                $rightList = Criteria::create(AclRight::dao())->add(Expression::eq('context', $form->getValue('id')->getId()))->getList();
