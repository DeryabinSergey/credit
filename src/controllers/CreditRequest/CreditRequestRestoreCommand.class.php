...
class CreditRequestRestoreCommand implements SecurityCommand, EditorCommand
{
    const ERROR_EXTERNAL = 0x0003;

    /**
     * @return CreditRequestRestoreCommand
     */
    ...
    public function run(Prototyped $subject, Form $form, HttpRequest $request)
    {
        ...
        if ($form->getValue('ok')) {
            try {
                ...
                $form->getValue('id')->dao()->restore($form->getValue('id'));
